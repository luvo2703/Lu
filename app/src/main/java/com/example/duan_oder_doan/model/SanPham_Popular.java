...
public class SanPham_Popular {
    private String img_product;
    private String name_product;
    private String price_product;
    private String note_product;

    public SanPham_Popular() {
    }

    public SanPham_Popular(String img_product, String name_product, String price_product, String note_product) {
